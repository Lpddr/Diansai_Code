...
/*************************** 硬件抽象层配置 ****************************/
// GPIO地址切换宏定义
#define Switch_Address_0(i) ((i)?(DL_GPIO_setPins(ADC_PORT,ADC_PIN0_PIN)) : (DL_GPIO_clearPins(ADC_PORT,ADC_PIN0_PIN)))// 地址位0控制

#define Switch_Address_1(i) ((i)?(DL_GPIO_setPins(ADC_PORT,ADC_PIN1_PIN)) : (DL_GPIO_clearPins(ADC_PORT,ADC_PIN1_PIN)))// 地址位1控制

#define Switch_Address_2(i) ((i)?(DL_GPIO_setPins(ADC_PORT,ADC_PIN2_PIN)) : (DL_GPIO_clearPins(ADC_PORT,ADC_PIN2_PIN)))// 地址位2控制
